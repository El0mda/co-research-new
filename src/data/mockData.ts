...
export const researchers: Researcher[] = [
  {
    id: "r1",
    name: "ايه هشام",
    nameEn: "Dr. Aya Hesham",
    email: "AHZaghloul@ftd.zu.edu.eg",
    avatar: "",
    degree: "دكتوراه",
    degreeEn: "PhD",
    university: "جامعة الزقازيق",
    universityEn: "Zagazig University",
...
export const projects: ResearchProject[] = [
  {
    ...
    description:
      "بحث يهدف إلى تطوير نموذج ذكاء اصطناعي للمساعدة في تشخيص الأمراض من الصور الطبية",
    descriptionEn:
      "Research aimed at developing an AI model to assist in diagnosing diseases from medical images",
    field: "علوم الحاسب",
    fieldEn: "Computer Science",
    subField: "الذكاء الاصطناعي",
    subFieldEn: "Artificial Intelligence",
    ...
    tasks: [
      {
        ...
        description: "مراجعة شاملة للدراسات السابقة",
        descriptionEn: "Comprehensive review of previous studies",
        assigneeId: "r1",
        status: "completed",
        dueDate: "2025-03-01",
      },
      {
        ...
        description: "جمع صور طبية من المستشفيات",
        descriptionEn: "Collect medical images from hospitals",
        assigneeId: "r2",
        status: "completed",
        dueDate: "2025-05-01",
      },
      {
        ...
        title: "بناء النموذج",
        titleEn: "Build Model",
        description: "تصميم وتدريب نموذج التعلم العميق",
        descriptionEn: "Design and train the deep learning model",
        assigneeId: "r1",
        status: "in-progress",
        dueDate: "2025-09-01",
      },
      {
        ...
        titleEn: "Test Model",
        description: "اختبار دقة النموذج على بيانات جديدة",
        descriptionEn: "Test model accuracy on new data",
        assigneeId: "r2",
        status: "in-progress",
        dueDate: "2025-11-01",
      },
      {
        id: "t5",
        title: "كتابة النتائج",
        titleEn: "Write Results",
        description: "توثيق وتحليل النتائج",
        descriptionEn: "Document and analyze results",
        assigneeId: "r1",
        status: "under-review",
        dueDate: "2026-01-15",
      },
      {
        ...
        description: "مراجعة نهائية للورقة البحثية",
        descriptionEn: "Final review of the research paper",
        assigneeId: "r2",
        status: "under-review",
        dueDate: "2026-03-01",
      },
    ...
    messages: [
      {
        id: "m1",
        senderId: "r1",
        text: "مرحبا بالجميع، هذه المجموعة لمشروعنا البحثي",
        textEn: "Welcome everyone, this is our research project group",
        timestamp: "2025-01-20T10:00:00Z",
      },
      {
        id: "m2",
        senderId: "r2",
        text: "شكرا دكتور أحمد، أنا متحمسة للبدء",
        textEn: "Thank you Dr. Ahmed, I am excited to start",
        timestamp: "2025-01-20T10:05:00Z",
      },
      {
        id: "m3",
        senderId: "r1",
        text: "أرفقت خطة البحث المبدئية",
        textEn: "I have attached the initial research plan",
        timestamp: "2025-01-21T09:00:00Z",
        attachment: { name: "research_plan_v1.pdf", type: "pdf" },
      },
      {
        id: "m4",
        senderId: "r2",
        text: "راجعت الخطة، لدي بعض الملاحظات",
        textEn: "Reviewed the plan, I have some notes",
        timestamp: "2025-01-22T14:30:00Z",
      },
      {
        id: "m5",
        senderId: "r1",
        text: "ممتاز، شاركي ملاحظاتك وسنناقشها",
        textEn: "Excellent, share your notes and we will discuss them",
  ...
  },
  {
    ...
    description:
      "دراسة مقارنة لتأثير التعلم الإلكتروني على تحصيل طلاب الجامعات السعودية",
    descriptionEn:
      "Comparative study of e-learning impact on Saudi university students achievement",
    field: "التربية",
    fieldEn: "Education",
  ...
  },
  {
    ...
    descriptionEn:
      "Research on techniques for improving cloud infrastructure performance",
    field: "علوم الحاسب",
    fieldEn: "Computer Science",
