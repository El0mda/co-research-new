...
const LandingPage: React.FC = () => {
  ...
  const reasons = t("reasons.items") as any as {
    title: string;
    desc: string;
  }[];
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, hsl(42 85% 50% / 0.15) 1px, transparent 1px)",
        ...
        <div
          ...
          style={{
            ...
            height: "60vh",
            background:
              "radial-gradient(ellipse, hsl(42 85% 50% / 0.08) 0%, transparent 70%)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "50vh",
            background:
              "radial-gradient(ellipse, hsl(222 52% 40% / 0.25) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="container relative py-28 md:py-40 text-center">
          ...
          >
            {[
              {
                num: "١١+",
                label: lang === "ar" ? "سببًا للانضمام" : "Reasons to join",
              },
              {
                num: "٣",
                label: lang === "ar" ? "خطط للأسعار" : "Pricing plans",
              },
              {
                num: "١٠٠٪",
                label: lang === "ar" ? "حماية للحقوق" : "Rights protected",
              },
            ].map((s, i) => (
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, hsl(42 85% 50% / 0.12) 1px, transparent 1px)",
        ...
        <div className="container relative">
          ...
          <div className="grid gap-6 md:grid-cols-3 max-w-4xl mx-auto">
            ...
            <PricingCard
              ...
              price={
                annual
                  ? t("pricing.researcher.priceAnnual")
                  : t("pricing.researcher.price")
              }
              currency={t("pricing.currency")}
              perMonth={t("pricing.perMonth")}
            ...
            <PricingCard
              ...
              price={
                annual
                  ? t("pricing.institution.priceAnnual")
    ...
    style={
      highlighted
        ? {
            ...
            boxShadow:
              "0 8px 40px hsl(0 0% 0% / 0.25), 0 2px 8px hsl(42 85% 50% / 0.2)",
          }
        : {
        ...
        <li key={i} className="flex items-start gap-2.5 text-sm">
          ...
          >
            <Check
              ...
              style={{
                color: highlighted ? "hsl(36 60% 32%)" : "hsl(var(--gold))",
              }}
            />
          </div>
          <span
